### modified from the original pytorch implementation of Transformer
import copy
...
class TransformerEncoderLayer(Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1, activation=F.relu,
        ...
        self.conv_pe = nn.Conv1d(d_model, d_model, kernel_size=31, stride=1, padding=15, bias=False)
    ...
    def _sa_block(self, x: Tensor,
        ...
        pe = self.conv_pe(x.transpose(-2, -1))
        pe = pe.transpose(-2, -1)
        x = self.self_attn(x, x, x+pe,
                           attn_mask=attn_mask,
