...
if totNumRows < 3
    seatStr = {'Row 1 Driver','Row 1 Passenger','Row 2 Seat','Row 2 footwear','Row 2 Passngr','driver footwear','passenger footwear','Row 2 footwear','','',''};
    %seatStr = {'Row 1 Driver','Row 1 Passenger','Row 2 Driver','Row 2 Middle','Row 2 Passngr','driver footwear','passenger footwear','Row 2 footwear','','',''};
else
