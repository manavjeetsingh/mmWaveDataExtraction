...
###################################################################################
vpath %.c ../../utils \
          ./datapath/dpc/objectdetection/objdetdsp/src \
          ./dss
		   	...
		   	-llibedma_$(MMWAVE_SDK_DEVICE_TYPE).$(C674_LIB_EXT)		\
        		-llibdpm_$(MMWAVE_SDK_DEVICE_TYPE).$(C674_LIB_EXT) 		\
	                ...
	                -llibrangeproc_dsp_$(MMWAVE_SDK_DEVICE_TYPE).$(C674_LIB_EXT)     \
                    	...
                    	-llibdpedma_base_$(MMWAVE_SDK_DEVICE_TYPE).$(C674_LIB_EXT)        \
...
DSS_MMW_DEMO_MAP         = $(MMWAVE_SDK_DEVICE_TYPE)_intf_demo_dss.map
DSS_MMW_DEMO_OUT         = $(MMWAVE_SDK_DEVICE_TYPE)_intf_demo_dss.$(C674_EXE_EXT)
DSS_MMW_DEMO_METAIMG_BIN = $(MMWAVE_SDK_DEVICE_TYPE)_intf_demo.bin
