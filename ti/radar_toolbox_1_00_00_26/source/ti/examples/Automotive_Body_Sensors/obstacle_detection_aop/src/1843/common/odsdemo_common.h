...
#define ODSDEMO_MAX_RX_ANT             12
#define ODSDEMO_PHY_RX_ANT             4

#ifdef ODS_3TX
#define ODSDEMO_NUM_ADOA_ANT           8     /* for 3x6 1843 ODS-like antennas */
#define ODSDEMO_NUM_EDOA_ANT           4     /* heatmap gen expects 4 or 8 antennas */
#elif ODS_1843_EVM
#define ODSDEMO_NUM_ADOA_ANT           8     /* for 1843 EVM */
#define ODSDEMO_NUM_EDOA_ANT           4
#else
#define ODSDEMO_NUM_ADOA_ANT           4     /* for 1843 AoP */
#define ODSDEMO_NUM_EDOA_ANT           4
#endif
