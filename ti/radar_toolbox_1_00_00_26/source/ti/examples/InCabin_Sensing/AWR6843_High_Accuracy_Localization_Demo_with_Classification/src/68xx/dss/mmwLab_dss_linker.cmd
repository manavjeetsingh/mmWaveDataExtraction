...
SECTIONS
{
    ...
    */ 
    ...
    } load=L3SRAM PAGE 0 , run=L1PSRAM PAGE 0, table(_mmwLab_fastCode_L1PSRAM_copy_table, compression=off)
    ...
    } load=L3SRAM PAGE 0, run=HSRAM PAGE 0, table(_mmwLab_configCode_HSRAM_copy_table, compression=off)
